...
var LoaderSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Enable autosave for files").addToggle((toggle) => toggle.setValue(this.plugin.settings.doAutosaveFiles).onChange(async (value) => {
...
var BaseView = class extends import_obsidian3.TextFileView {
...
// src/views/json-view.ts
var JsonView = class extends BaseView {
  constructor(leaf, plugin) {
    super(leaf, plugin);
  }
  getViewType() {
  ...
  getEditorExtensions() {
    ...
    extensions = [
      ...
      json(),
      import_view5.EditorView.updateListener.of(this.onEditorUpdate.bind(this))
    ];
    return extensions;
  }
};
...
var TxtView = class extends BaseView {
  constructor(leaf, plugin) {
    super(leaf, plugin);
  }
  getViewType() {
  ...
  getEditorExtensions() {
    ...
    extensions = [
      ...
      import_view6.EditorView.updateListener.of(this.onEditorUpdate.bind(this))
    ];
    return extensions;
  }
};

// src/loader-plugin-settings.ts
...
// src/main.ts
var LoaderPlugin = class extends import_obsidian4.Plugin {
  async onload() {
  ...
  registerContextMenuCommand(fileExt) {
    this.registerEvent(
      this.app.workspace.on("file-menu", (menu, file) => {
        const parent = file instanceof import_obsidian4.TFile ? file.parent : file;
        menu.addItem((item) => {
